...
Halo, Saya <span class="text-blue-600">Syahdan Basir</span>
</h1>
...
<div class="md:w-1/2 flex justify-center animate-slide-in-right">
  <img src="/orang.jpg" alt="Foto Profil"
     class="w-20 h-20 md:w-10 md:h-10 rounded-full object-cover shadow-lg">
</div>
</section>
</template>